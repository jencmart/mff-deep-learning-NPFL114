    ...
    def train_epoch(self, dataset):
        for batch in dataset.batches(args.batch_size):
            ...
            with tf.GradientTape() as tape:
                ...
                probabilities = self.predict(batch["images"])  # [ args.batch_size , MNIST.LABELS ]
            ...
            for variable, gradient in zip(variables, gradients):
                # Perform the SGD update with learning rate `args.learning_rate`
                # for the variable and computed gradient.
                # You can modify variable value with `variable.assign`
                # or in this case the more efficient `variable.assign_sub`.
                variable = tf.compat.v1.assign_sub(variable, args.learning_rate * gradient)
