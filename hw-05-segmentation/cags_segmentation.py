...
def PSPNet(
    ...
    backend, layers, models, keras_utils = None, None, None, None  # get_submodules_from_kwargs(submodule_args)
    ...
    feature_layers = x # Backbones.get_feature_layers(backbone_name, n=3)
