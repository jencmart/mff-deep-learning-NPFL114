...
if __name__ == "__main__":
    ...
    # todo -- this is 3x slower --- speed it up using the tf.function
    for epoch in range(args.epochs):
        accuracy.reset_states()
        for batch in mnist.train.batches(args.batch_size):
            # todo -- see we are using the gradient tape -- nice shit bro
            ...
            # todo -- applying gradinets -- see, even Adam just take the gradients (Jacobians)
