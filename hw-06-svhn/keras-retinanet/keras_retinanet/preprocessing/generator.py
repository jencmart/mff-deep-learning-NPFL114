...
class Generator(keras.utils.Sequence):
    ...
    def __init__(
        ...
        compute_anchor_targets=compute_anchor_targets_bbox,
    ...
    # todo --- tady vyrobime anchor targets ...
    def compute_targets(self, image_group, annotations_group):  # todo
        """ Compute target outputs for the network using images and their annotations.
        """
        # get the max image shape (h,w,ch)
        max_shape = tuple(max(image.shape[x] for image in image_group) for x in range(3))

        # generate anchors !!!!!! --- this we need to implement
        anchors = anchors_for_shape(max_shape, anchor_params=None, shapes_callback=self.compute_shapes)
    ...
    def compute_input_output(self, group):  # todo
