...
def retinanet_bbox(
    ...
    **kwargs
    ...
    if model is None:
        model = retinanet(num_anchors=anchor_params.num_anchors(), **kwargs)  # we use retina-net model model ....
    else:
    ...
    boxes = layers.ClipBoxes(name='clipped_boxes')([model.inputs[0], boxes]) # poslu tam puvodni obrazek + boxes
